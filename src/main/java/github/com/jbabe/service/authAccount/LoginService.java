...
import github.com.jbabe.web.dto.authAccount.LoginResponse;
...
//    @Transactional
    public LoginResponse login(String email, String password) {
        ...
        try {
            ...
            return new LoginResponse(accessToken, refreshToken, user.getEmail(), user.getName(), user.getRole());
    ...
    @Transactional
    public String disableToken(String email, String accessToken) {
        try {
